...
class KeyValueStorage {
  static const _feedListPagesBoxKey = 'feed-list-pages';
  static const _favoriteFeedListPagesBoxKey = 'favorite-feed-list-pages';
  static const _darkModePreferenceBoxKey = 'dark-mode-preference';
  static const _bookedPublishersBoxKey = 'booked-publishers';
  ...
  KeyValueStorage({
    ...
    try {
      _hive
        // ..registerAdapter(FeedListPageCMAdapter())
        // ..registerAdapter(FeedCMAdapter())
  ...
  Future<Box<List<String>>> get bookedPublishersBox =>
      _openHiveBox<List<String>>(
        _bookedPublishersBoxKey,
        isTemporary: false,
      );
